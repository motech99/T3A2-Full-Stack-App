...
**User Story:**
As a user looking to hire some equipment, I want to be able to view all of the equipment available to hire so that I can make the decision to register and book or not.

- **Priority:** High

- **Accept/Reject:** Accept

**User Story:** As a user looking to hire an item for a specific length of time, I want to be able to view all of the hire options (length of hire) so that I can make the decision to register and book or not.

- **Priority:** High
- **Accept/Reject:** Accept

**User Story:** As a user looking for the best price, I want to be able to view the price of hiring equipment so that I can make the decision to register and book or not.

- **Priority:** High
- **Accept/Reject:** Accept

**User Story:** As a busy person I want to be able to book equipment online so that I don’t have to call or book in person.

- **Priority:** High
- **Accept/Reject:** Accept

**User Story:** As a user with a specific date in mind, I want to be able to select a date and time for my booking so that the equipment selected is available when I need it.

- **Priority:** High
- **Accept/Reject:** Accept

**User Story:** As a user booking equipment for me and my family, I want to be able to select multiple bikes at a time so that I don’t have to individually book 3 bikes.

- **Priority:** Medium
- **Accept/Reject:** Accept

**User Story:** As an international tourist, I want to be able to use and understand the application so I can successfully make a booking on my holiday.

- **Refinement 1:** As an international tourist that can not read English very well, I want to clearly see pictures of each piece of equipment available so that I can accurately select what I want to hire.

  - **Priority:** High
  - **Accept/Reject:** Accept

- **Refinement 2:** As an international tourist I want to be able to change the language settings so that I can read in my own language.
  - **Priority:** Low
  - **Accept/Reject:** Reject

- **Refinement 3:** As an international tourist I want to be able to change the price to show in my own currency so that I have a better understanding of how much it will cost.
  - **Priority:** Low
  - **Accept/Reject:** Reject

**User Story:** As a user with limited technical proficiency, I want to be able to navigate the website with ease so that I am able to make a booking.

- **Priority:** Medium
- **Accept/Reject:** Accept

**User Story:** As a user that only has a phone and not an iPad or laptop, I want to be able to have full functionality so that I can still make a booking.
...
**User Story:** As a frequent user I want to be able to register my details so that I do not have to enter my personal details multiple times.
...
- **Refinement 2:** As a registered user with a change of plans, I want to be able to update or delete my booking online to a new date that suits.
...
**User Story:** As an admin I want to be able to view a complete list of the bookings made so that I can have a history of our transactions.

- **Priority:** High
- **Accept/Reject:** Accept

**User Story:** As an admin I want to be able to add/update/delete bookings so that I can also manually enter bookings from in person customers.

- **Priority:** Medium
- **Accept/Reject:** Accept

**User Story:** As an admin, I want to be able to update the details of equipment so that their descriptions, availability and price remains up to date.

- **Priority:** High
- **Accept/Reject:** Accept

**User Story:** As an admin I want to be able to add new equipment so that we can offer more equipment as we expand.

- **Priority: High
- **Accept/Reject: Accept

**User Story:** As an admin I want to be able to filter bookings so that I can see the bookings for today and I can prepare the appropriate equipment.

- **Priority:** Medium
- **Accept/Reject:** Accept

**User Story:** As an admin I want to be able to be able to grant admin privileges so that if my business grows I can have multiple admin.
